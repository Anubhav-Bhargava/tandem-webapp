...
const DataStatsAnalytics: React.FC = () => {
  return (
    <div>
        ...
        <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5">
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="font-medium">Utilization Percentage</p>
              <span className="mt-2 flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Since yesterday</span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5">
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="font-medium">Downtime Percentage</p>
              <span className="mt-2 flex items-center gap-2">
        ...
        <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5">
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="font-medium">Avg Fuel / Vehicle</p>
        ...
        <div className="rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-7.5">
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="font-medium">Over Time</p>
              <span className="mt-2 flex items-center gap-2">
                <span className="flex items-center gap-1 rounded-md bg-meta-3 p-1 text-xs font-medium text-white">
                <svg
                    width="14"
...
export default DataStatsAnalytics;
